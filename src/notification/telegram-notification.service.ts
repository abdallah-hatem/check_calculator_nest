...
export class TelegramNotificationService {
    ...
    async sendError(errorMessage: string, context?: Record<string, any>): Promise<void> {
    ...
    async sendScanReceiptError(error: Error, additionalInfo?: Record<string, any>): Promise<void> {
        const context = {
            service: 'AIService',
            method: 'scanReceipt',
